...
// Function to update SN
function updateSerialNumbers() {
  console.log("updateSerialNumbers");
  $("#sales_table tbody tr").each(function (index, tr) {
    console.log(index);
    console.log(tr);
    $(tr)
      .find("td.sn_column")
      .text(index + 1); // Assuming the SN column has the class 'sn_column'
  });
}
...
function return_row_with_data(item_id) {
  ...
  $.post(
    ...
    function (result) {
      ...
      $("#item_search").removeClass("ui-autocomplete-loader-center");
      $("#item_search").removeClass("ui-autocomplete-loading");
      $("#sales_table tbody select").select2();
