...
class Stock_transfer_model extends CI_Model
{
	...
	var $column_order = array('a.id', 'a.reference_no', 'a.transfer_date', 'a.note', 'a.warehouse_from', 'a.warehouse_to', 'a.created_by', 'a.store_id'); //set column field database for datatable orderable
	var $column_search = array('a.id', 'a.reference_no', 'a.transfer_date', 'a.note', 'a.warehouse_from', 'a.warehouse_to', 'a.created_by', 'a.store_id'); //set column field database for datatable searchable 
	...
	public function verify_save_and_update()
	{
		...
		$reference_no = strtoupper("" . str_shuffle(rand(100000, 999999)));
		$prev_item_ids = array();
