<div class="modal fade " id="new-order-modal" tabindex='-1'>
    <?= form_open('#', array('class' => '', 'id' => 'new-order-form')); ?>
    <div class="modal-dialog modal-md">
        <div class="modal-content">
                    ...
                    <div class="col-md-4">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " id="customer_email" name="customer_email" placeholder="Enter Email Address">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select readonly class="form-control select2" id="product_type" name="product_type" style="width: 100%;" onchange="updateProductSelect()">
                    ...
                    <div class="col-md-4">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control " id="shopify_id" name="shopify_id" placeholder="Enter Shopify ID">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="country" name="country" style="width: 100%;" onkeyup="shift_cursor(event,'state')">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control pull-right datepicker" id="order_date" name="order_date">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="new-order-form-button">Save</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
