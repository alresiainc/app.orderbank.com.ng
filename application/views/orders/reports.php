...
<body class="hold-transition skin-blue sidebar-mini">
                                            ...
                                            <div class="box-info">
                                                <div class="box-header">
                                                    <div class="col-md-8 col-md-offset-2 text-center">
                                                        <label for="search_state">Select States to View
                                                        </label></label>
                                                        <select class="form-control select2" id="search_state"
                                                            name="search_state" style="width: 100%;"
                                                            onkeyup="shift_cursor(event,'state')" multiple>
                                                            <?= get_state_select_list(null, true); ?>
                                                        </select>
                                                        <span id="search_state_msg" style="display:none"
                                                            class="text-danger"></span>
                                                    </div>
                                                    <div class="col-md-8 col-md-offset-2 text-center">
    ...
    <script>
        ...
        function load_datatable() {
            ...
            var table = $('#order_table').DataTable({
                ...
                "createdRow": function(row, data, dataIndex) {
                    ...
                    var filteredstate = api.column(9).data().filter(function(value, index) {
                        return notTrueRows.indexOf(index) !== -1;
                    });
                    ...
                    if (filteredDate.length > 0) {
                        ...
                        var selectedCountries = Array.from(new Set(filteredstate.toArray()));
        ...
        $(document).ready(function() {
            ...
            $("#search_state, #search_from_date, #search_status, #search_to_date").on("change", function() {
                $('#order_table').DataTable().ajax.reload();
            ...
            $('#new-order-form-button').click(function(e) {
                ...
                if (check_field("shopify_id") == false || check_field("product_id") == false || check_field(
                        "state") == false || check_field("order_date") == false) {
                    toastr["warning"]("You have Missed Something to Fillup!");
                    return;
                }
