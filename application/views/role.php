                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="change_me" id="orders"> <?= $this->lang->line('select_all'); ?>
                                </label></div>
                            </td>
                            <td>
                              <input type="hidden" name="module[orders]" value="on">
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="view_orders" name="permission[view_orders]"> View Orders
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="edit_orders" name="permission[edit_orders]"> Edit Orders
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="delete_orders" name="permission[delete_orders]"> Delete Orders
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="change_status" name="permission[change_status]"> Change Status
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="view_history" name="permission[view_history]"> View History
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="copy_order" name="permission[copy_order]"> Copy Order
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="view_receipt" name="permission[view_receipt]"> View Receipt
                                </label></div>

                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="orders_all" id="view_reports" name="permission[view_reports]"> View Report
                                </label></div>
                              <div class="checkbox icheck"><label>
                          ...
                          <tr>
                            <td><?= $i++; ?></td>
                            <td>Orders Statuses View</td>
                            <td>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="change_me" id="order_statuses"> <?= $this->lang->line('select_all'); ?>
                                </label></div>
                            </td>
                            <td>
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="change_me" id="form"> <?= $this->lang->line('select_all'); ?>
                                </label></div>
                            </td>
                            <td>
                              <input type="hidden" name="module[form]" value="on">
                              ...
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="form_all" id="delete_form" name="permission[delete_form]"> Delete Form
                                </label></div>
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="form_all" id="duplicate_form" name="permission[duplicate_form]"> Duplicate Form
                                </label></div>
                              <div class="checkbox icheck"><label>
                              ...
                              <div class="checkbox icheck"><label>
                                  <input type="checkbox" class="form_all" id="delete_form_bundle" name="permission[delete_form_bundle]"> Delete Form Bundle
                                </label></div>
