...
<script type="text/javascript">
    newPageTitle = '<?=str_replace('---', '-', str_replace(' ', '-', strtolower($customer_name)))."-".date('M')."_".date('d')."_".date('Y')."-sales-invoice";?>';
    document.title = newPageTitle;
</script>
<caption>
      <center>
        <p style="background-color:#30148c; font-size: 20px; color:white; text-align:center; text-transform: uppercase;">PAYMENT REQUEST / SALES INVOICE</p>
        <span style="font-size: 16px;">
        <?php echo $this->lang->line('name').": ".$customer_name; ?><br/><br/>
        </span>
      </center>
</caption>
                ...
                <td colspan="8" rowspan="1">
                  <span>
                    <table style="width: 100%;" class="style_hidden fixed_table">
                        ...
                        <tr>
                        <td colspan="8">
                            Sales Week:<span style="font-size: 10px;"> <?php echo "$reference_no"; ?></b>
                            </span>
                          </td>
                        </tr>
                        <tr>
...
<tbody>
 ...
 <?php
              ...
              $this->db->select(" a.description,c.item_name, a.sales_qty,
                                  ...
                                  a.total_cost, a.order_details, d.unit_name,c.sku,c.hsn
                              ");
              ...
              foreach ($q2->result() as $res2) {
                  ...
                  $order = json_decode($res2->order_details, true) ?? [];
                  ...
                  echo "<td colspan='1' class='text-center'>".$i++."</td>";
                    ...
                    echo "<br><i>[".nl2br($order['order_number'])."] ".$order['state']."</i>";
                    echo "</td>";
                   //End order details
                  echo "<td colspan='3'>";
                  echo $res2->item_name;
...
<tfoot>
  ...
  <tr class="bg-sky">
    <td colspan="7" class='text-center text-bold'><?= $this->lang->line('total'); ?></td>
