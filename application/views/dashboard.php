          ...
          <div class="row">
            ...
            <div class="col-md-4 col-sm-8 col-xs-12">
              <div class="small-box bg-1">
                <div class="inner">
                  <h3 class="total_purchase"><?= $CI->currency(0); ?></h3>
                  <p><?= $this->lang->line('purchase'); ?></p>
                </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box ">
                ...
                <div class="info-box-content">
                  <span class="info-box-text tot_stock_trns" style="font-size: 25px;"><?= $CI->currency(0); ?></span>
                  <!--<span class="info-box-number" style=""><?= $this->lang->line('suppliers'); ?></span>-->
                  <span class="info-box-number" style="">WAYBILLS</span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box ">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number" style=""><?= $this->lang->line('purchases'); ?></span>
                </div>
                <!-- /.info-box-content -->
              </div>
              <!-- /.info-box -->
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box ">
                ...
                <div class="info-box-content">
                  ...
                  <span class="info-box-number" style="">Revenues</span>
                </div>
        ...
        <div class="row">
          <?php if (!is_user() && $CI->permissions('dashboard_pur_sal_chart')) { ?>
            ...
            <div class="col-md-4">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title text-uppercase">Best Selling Bundles</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive ">
                  <table class="table ">
                    ...
                    <tbody>
                      <?php
                      $i = 1;
                      $store_id = get_current_store_id(); // Get the current store ID dynamically

                      // SQL query to fetch best-selling bundles
                      $b1 = $this->db->select('b.name AS bundle_name, 
                             b.price AS bundle_price, 
                             COUNT(o.form_bundle_id) AS total_orders')
                        ->from('db_form_bundles as b')
                        ->join('db_orders as o', 'b.id = o.form_bundle_id', 'left')
                        // ->where('o.store_id', $store_id) // Ensure filtering by store ID
                        ->group_by('b.id')
                      ...
                      if ($b1->num_rows() > 0) {
                        foreach ($b1->result() as $res5) {
                      ?>
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $res5->bundle_name; ?></td>
                            <td><?php echo $CI->currency($res5->bundle_price, $with_comma = true); ?></td>
                            <td><?php echo $res5->total_orders; ?></td>
                          </tr>
                      <?php
                        }
                      } else {
                      ...
                      <tfoot>
                        <tr>
                          <td colspan="4" class="text-center">
                            <a href="<?php echo $base_url; ?>bundles" class="uppercase"><?= $this->lang->line('view_all'); ?></a>
                          </td>
                        </tr>
                      </tfoot>
                    <?php } ?>
        ...
        <?php if (!is_user()) { ?>
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title text-uppercase">Returning Customers</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      // Query to fetch returning customers
                      $q = $this->db->select("
                        o.customer_name,
                        o.customer_email,
                        o.customer_phone,
                        s.state AS state_name,
                        GROUP_CONCAT(DISTINCT b.name SEPARATOR ', ') AS items_bought,
                        GROUP_CONCAT(DISTINCT o.order_number SEPARATOR ', ') AS order_numbers,
                        COUNT(o.id) AS total_orders
                    ")
                        ->from('db_orders o')
                        ->join('db_states s', 'o.state = s.id', 'left')
                        ->join('db_form_bundles b', 'o.form_bundle_id = b.id', 'left')
                        ->group_by(['o.customer_name', 'o.customer_email', 'o.customer_phone'])
                        ->having('total_orders >', 1) // Filter customers with more than one order
                        ->order_by('total_orders', 'DESC')
                        ->limit(10)
                        ->get();
                      ...
                      if ($q->num_rows() > 0) {
                        foreach ($q->result() as $row) {
                          // Create clickable links for each order number
                          $order_links = implode(', ', array_map(function ($order_number) use ($base_url) {
                            return "<a href=\"{$base_url}orders?order_number={$order_number}\" target=\"_blank\">#{$order_number}</a>";
                          }, explode(', ', $row->order_numbers)));
                      ?>
                          <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo $row->customer_name; ?></td>
                            <td><?php echo $row->state_name ?: 'Unknown'; ?></td>
                            <td><?php echo $row->items_bought; ?></td>
                            <td><?php echo $order_links; ?></td>
                          </tr>
                      <?php
                        }
                      } else {
                        echo "<tr><td colspan='5' class='text-center'>No returning customers found</td></tr>";
                      }
                      ?>
                    </tbody>
                  </table>
