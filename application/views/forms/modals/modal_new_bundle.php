            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="box-body">
                            <div class="form-group">
                                <label for="bundle_quantity">Quantity *</label>
                                <label id="bundle_quantity_msg" class="text-danger text-right pull-right"></label>
                                <input type="number" class="form-control " id="bundle_quantity" min="1"
