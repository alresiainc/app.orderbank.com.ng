            ...
            <section class="content">
                <div class="box box-primary" style="padding: 10px;">
                    <div class="box-body">
                        ...
                        <!-- Products -->
                        <div class="form-group">
                            <label>Select Product Bundle:</label>
                            ...
                            <label id="product_msg" class="text-danger"></label>
                        </div>
                        <!-- Submit Button -->
                    ...
                    if (data.success == true) {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                window.location.href = "<?php echo site_url('forms/view_form/') ?>/" + data.form_id;
