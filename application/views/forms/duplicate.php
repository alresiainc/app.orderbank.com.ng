...
<body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Duplicate Form</li>
                </ol>
            </section>

            <!-- Main content -->
            <?= form_open('form_builder/duplicate_form/' . $form->id, array('class' => '', 'id' => 'update-form')); ?>
            <section class="content">
                <div class="box box-primary" style="padding: 10px;">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-12 form-row">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="form_name" name="form_name" placeholder="Enter Form Name" value="<?= $form->form_name; ?> Copy">
                            ...
                            <div class="col-sm-12 form-row">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right" id="form_link" name="form_link" value="<?= $form_link; ?>" placeholder="Customize the form link">
                                    </div>
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="btn btn-primary" id="update-form-button">Duplicate Form</button>
                    </div>
                </div>
            </section>
            <?= form_close(); ?>
    ...
    <script>
        ...
        $('#update-form-button').click(function(e) {
            ...
            // $.ajax({
            //     type: 'POST',
            //     url: "<?php echo site_url('forms/create_form/' . $form->id) ?>",
            //     data: data,
            //     cache: false,
            //     contentType: false,
