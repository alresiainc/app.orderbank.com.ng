            ...
            <div class="box box-primary">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <?php if (true) {
                    $this->load->view('warehouse/warehouse_code', array('show_warehouse_select_box' => true, 'div_length' => 'col-sm-3', 'show_alls' => false, 'form_group_remove' => 'true', 'show_all_option' => true));
                  } else {
