...
<body class="hold-transition skin-blue sidebar-mini">
               ...
               <div class="col-md-12">
                  ...
                  <div class="box box-primary ">
                     ...
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           <label for="reference_no" class="col-sm-2 control-label">Sales Week</label>
                           <div class="col-sm-3">
   ...
   <script src="<?php echo $theme_link; ?>js/sales.js?<?php echo time(); ?>"></script>
   <script>
         ...
         for (i = 1; i <= rowcount; i++) {
            ...
            if (document.getElementById("td_data_" + i + "_3")) {
               ...
               if ($("#td_data_" + i + "_3").val() != null && $("#td_data_" + i + "_3").val() != '') {
                  actual_taxable = actual_taxable + + +(parseFloat($("#td_data_" + i + "_13").val()) * parseFloat($(
                     "#td_data_" + i + "_3").val()));
      ...
      function removerow(id) { //id=Rowid
         ...
         $("#row_" + id).remove();
         final_total();
         // Call updateSerialNumbers() to refresh the SN
         updateSerialNumbers();
         failed.currentTime = 0;
         failed.play();
      }
      ...
      function set_tax_value(row_id) {
         ...
         sales_price_without_quantity = sales_price;
         ...
         //Calculate discount NEW     (adjust delivery fee) // This Line was changed by Fide
         var discount_amt = (item_discount_type == 'Percentage') ? ((sales_price_without_quantity) *
            item_discount_input) / 100 : (item_discount_input);
         sales_price_without_quantity -= parseFloat(discount_amt);

         var tax_amount = (tax_type == 'Inclusive') ? calculate_inclusive(sales_price_without_quantity, tax) :
            calculate_exclusive(sales_price_without_quantity, tax);
