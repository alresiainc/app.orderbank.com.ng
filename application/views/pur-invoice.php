...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <?php
    $CI =& get_instance();
    $q3=$this->db->query("SELECT b.store_id,b.warehouse_id,a.supplier_name,a.mobile,a.phone,a.gstin,a.tax_number,a.email,
    ...
    $warehouse_name=get_warehouse_name($res3->warehouse_id);
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <address>
           ...
           <i><?= $this->lang->line('warehouse'); ?><br></i>
          <address>
            <strong><?php echo  $warehouse_name; ?></strong><br>
            </address>
        </div>
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
