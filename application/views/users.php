                        ...
                        <div class="box-body">
                           <div class="row">
                              <div class="col-md-6">
                                 ...
                                 <!-- Warehouse Code end -->
                                 <div class="form-group">
                                    <label for="states" class="col-sm-4 control-label">States<label class="text-danger">*</label> </label>
                                    <div class="col-sm-8">
                                       <select class="form-control select2" id="states" name="states[]" style="width: 100%;" multiple>
                                          <?php
                                          $states = $this->db->select("*")->where("status=1")->from("db_states")->order_by('state')->get();

                                          ?>
                                          <?php foreach ($states->result() as $res1): ?>
                                             <?php $selected = (in_array($res1->id, $states_ids)) ? 'selected' : ''; ?>
                                             <option <?= in_array($res1->id, $states_ids) ? 'selected' : ''; ?> value="<?= $res1->id; ?>"><?= $res1->state; ?></option>
                                          <?php endforeach; ?>

                                       </select>
                                       <span id="states_msg" style="display:none" class="text-danger"></span>
                                    </div>
                                 </div>
                              </div>
                              <div class="col-md-6">
